      ...
      <q-card class="my-card bg-white q-pa-md">
        <div class="row justify-center">
          <div class="col">
            ...
            <div><strong>Loại:</strong> {{ offlineOrder.type }}</div>
            <div>
              <strong>Hình thức thanh toán:</strong>
              {{ offlineOrder.payment_type }}
            </div>
            <div><strong>Tổng tiền:</strong> {{ offlineOrder.total }} VND</div>
            <div>
              <strong>Thời gian mua:</strong>
              {{ formatDate(offlineOrder.created_at) }}
            </div>
            <h5>Các sản phẩm</h5>
