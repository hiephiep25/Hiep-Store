          ...
          <div class="row justify-center">
            <div class="col">
              <div class="row">
                ...
                <div class="col-6">
                  <CommonSelectBox
                    v-model:model-value="supplier_id"
                    width-common="col-12 q-ml-lg"
                    width-label="col-2"
                    label="Nhà cung cấp"
    ...
    <q-card style="width: 700px">
      <div class="q-dialog__content q-pa-md" style="height: 100%; width: 100%">
        ...
        <div class="document-info">
          <p>
            <strong>Tên sản phẩm:</strong> {{ selectedDocument.product_name }}
          </p>
          ...
          <p>
            ...
            {{ selectedDocument.manufacture_day }}
          </p>
      ...
      <q-card-actions
        align="center"
        v-if="selectedDocument.status == 'AWAIT_APPROVAL'"
      >
