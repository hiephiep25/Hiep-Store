            ...
            <q-card-section class="align-self-center">
                <q-form class="q-gutter-md" @submit="update()">
                    <div class="row justify-center">
                        <div class="col-12">
                            <Input v-model:model-value="form" name="user_name" type="text" width-common="col-8 q-ml-lg"
                                width-label="col-2" label="Tên" :errors="errors" disable/>
                            <Input v-model:model-value="form" name="user_email" type="text" width-common="col-8 q-ml-lg"
                                width-label="col-2" label="Email" :errors="errors" disable/>
                            <SelectBox v-if="isAdmin" v-model:model-value="form" name="store_id" width-common="col-8 q-ml-lg"
                                width-label="col-2" label="Thuộc cửa hàng" :option="stores" :errors="errors"/>
                            <SelectBox v-model:model-value="form" name="status" width-common="col-8 q-ml-lg"
                                width-label="col-2" label="Tình trạng" :option="status" :errors="errors" />
                        </div>
                    </div>
                    <div class="row justify-center">
