...
export default {
    ...
    setup() {
        ...
        const updateChart = async () => {
            const data = await orderStore.getOfflineRevenuesByMonth(selectedYear.value);
            ...
            currentChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: `Doanh thu offline theo tháng của năm ${selectedYear.value}`,
                            data: values,
